...
export default function Industries() {
  return (
    <main>
      ...
      <section className="py-12"><Container><SectionHeading center eyebrow="Test Automation" title="Production & Test Coverage Across" highlight="Industries" /><div className="mt-8 grid gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7">{industryTestCoverage.map((item) => <FeatureCard key={item.title} {...item} compact />)}</div></Container></section>
